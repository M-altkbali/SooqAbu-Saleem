            ...
            <div class="contact-form check-out space-50">
                <div class="col-md-8 padding-left-0">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputcompany">Address *</label>                            
                            <input type="text" class="form-control" id="inputcompany">  
                        </div>   
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputfname1">City *</label>                            
                            <input type="text" class="form-control" id="inputfname1" >  
                        </div>
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputlname1">Country *</label>                            
                            <input type="text" class="form-control" id="inputlname1">  
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputcompany1">Phone *</label>                            
                            <input type="text" class="form-control" id="inputcompany1">  
                        </div>  
                        <div class="form-group col-md-12">
                            <button type="submit" class="btn link-button" value="Submit">Continue</button>
                            <span class="ship-adress">Ship to different address</span>
                        </div> 

                    </form>   
                    <div class="billing-info-menu">
                    <div class="title-ver3">
                        <h3><span>B</span>illing info</h3>
                    </div>
                    <form class="form-horizontal">
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputfname2">First Name*</label>                            
                            <input type="text" class="form-control" id="inputfname2" >  
                        </div>
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputlname2">Last Name*</label>                            
                            <input type="text" class="form-control" id="inputlname2">  
                        </div>
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputemail2">Company Name</label>                            
                            <input type="text" class="form-control" id="inputemail2">  
                        </div>
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputcompany2">Address *</label>                            
                            <input type="text" class="form-control" id="inputcompany2">  
                        </div>   
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputfname3">City *</label>                            
                            <input type="text" class="form-control" id="inputfname3" >  
                        </div>
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputlname3">Country *</label>                            
                            <input type="text" class="form-control" id="inputlname3">  
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label class=" control-label" for="inputcompany3">Phone *</label>                            
