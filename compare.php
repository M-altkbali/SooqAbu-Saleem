     ...
     <body>
                    ...
                    <li class="level1 dropdown">
                        ...
                        <div class="sub-menu dropdown-menu">
                          <ul class="menu-level-1">
                            ...
                            <li class="level2">
                                <img src="assets/images/products/1.jpg" alt="Sub-Menu" />
                            </li>
                          </ul>
                      </div>
                      <!-- End Dropdow Menu -->
        ...
        <div class="breadcrumb">
          ...
          <div class="main-content">
                <div class="container">
                    <div class="compare">
                        <ul class="title-compare">
                            <li class="images">
                                
                            </li>
                            <li class="cateogry">Category</li>
                            <li class="carrier">Carrier</li>
                            <li class="form-factor">Form Factor</li>
                            <li class="color">color</li>
                            <li class="os">os</li>
                            <li class="size">size</li>
                            <li class="battery">battery</li>
                            <li class="battery1">battery</li>
                        </ul>
                        <ul class="product-compare">
                            <li class="images">
                            <div class="product">
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product1.jpg" alt="images"/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="assets/images/Dana-home1-product1.jpg" alt="images"/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product1.jpg" alt="images"/>'>
                                            <a href="#" title="products">
                            ...
                            <li class="cateogry">MIO Alpha 79405 Heart Rate</li>
                            <li class="carrier">AT&T</li>
                            <li class="form-factor">Wearable Tech</li>
                            <li class="color">Dark Gray</li>
                            <li class="os">Tizen based wearable platform</li>
                            <li class="size">51g</li>
                            <li class="battery">BATTERY TYPE AND SIZE <p>300mAh Li-ion</p> </li>
                            <li class="battery1">INTERNAL MEMORY
                                <p>(User memory is less than the total memory due to storage of the operating system and software used to operate the features. Actual user memory will vary depending on the operator and may change after software upgrades are performed.)4GB Internal Memory / RAM 512MB</p></li>
                        </ul>
                        <ul class="product-compare">
                            <li class="images">
                                <div class="product">
                            ...
                            <li class="cateogry">Mota SmartWatch G2 Pro</li>
                            <li class="carrier">AT&T</li>
                            <li class="form-factor">Wearable Tech</li>
                            <li class="color">Dark Gray</li>
                            <li class="os">Tizen based wearable platform</li>
                            ...
                            <li class="battery">BATTERY TYPE AND SIZE <p>300mAh Li-ion</p></li>
                            <li class="battery1">INTERNAL MEMORY
                                <p>(User memory is less than the total memory due to storage of the operating system and software used to operate the features. Actual user memory will vary depending on the operator and may change after software upgrades are performed.)4GB Internal Memory / RAM 512MB</p>
                            </li>
                        </ul>
                        <ul class="add-compare">
                            <li class="images">
                                <a href="#" title="title">
                                    <img src="assets/images/add_compare.jpg" alt="Add Compare">
                                    <p>Add a product</p>
                                </a>
                            </li>
                            <li class="cateogry"></li>
                            <li class="carrier"></li>
                            <li class="form-factor"></li>
                            <li class="color"></li>
                            <li class="os"></li>
                            <li class="size"></li>
                            <li class="battery"></li>
                            <li class="battery1"></li>
                        </ul>
                    </div>
                    <!-- End compare -->
